        ...
        <main className="bg-gray-500 min-h-screen flex flex-col text-white">
            ...
            <div className="flex flex-col items-center p-4 sm:p-8">
                <div className="w-full md:w-2/3 max-w-5xl bg-black bg-opacity-30 p-6 rounded-lg shadow-lg">
                    <h1 className="text-3xl md:text-4xl text-center font-bold mb-4">About Me</h1>
                    <p className="mb-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 mb-4 justify-center">
                        <button
                            ...
                            className={`w-full sm:w-1/3 px-4 py-2 rounded ${activeTab === "Skills" ? "bg-teal-500 text-white" : "bg-gray-700 text-white"} hover:bg-teal-500 hover:text-white hover-delay`}
                        >
                            Skills
                        </button>
                        <button
                            onClick={() => setActiveTab("Experience")}
                            className={`w-full sm:w-1/3 px-4 py-2 rounded ${activeTab === "Experience" ? "bg-teal-500 text-white" : "bg-gray-700 text-white"} hover:bg-teal-500 hover:text-white hover-delay`}
                        >
                            Experience
                        </button>
                        <button
                            onClick={() => setActiveTab("Education")}
                            className={`w-full sm:w-1/3 px-4 py-2 rounded ${activeTab === "Education" ? "bg-teal-500 text-white" : "bg-gray-700 text-white"} hover:bg-teal-500 hover:text-white hover-delay`}
                        >
                            Education
                        </button>
                    </div>
